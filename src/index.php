...
<body>
	...
	<section class="feedback">
		<div class="container">
			...
			<p class="feedback">Настрой форму обратной связи и отправь свои данные, когда закончишь с задачей=)</p>

			<form action="/request_form.php" class="feedback__form">
				<input type="text" name="" class="feedback__input">
				<input type="text" name="" class="feedback__input">
				<input type="text" name="" class="feedback__input">
				<input type="text" name="" class="feedback__input">

				<input type="submit" class="feedback__submit">
			</form>
		</div>
	</section>
